...
//         public PostgresDatabaseService(IConfiguration configuration)
//         {
...
//             // Get allowed tables from configuration
//             var allowedTables = _configuration.GetSection("Database:AllowedTables").Get<List<string>>() ?? new List<string>();
//             var excludedTables = _configuration.GetSection("Database:ExcludedTables").Get<List<string>>() ?? new List<string>();

//             // Filter tables before grouping
//             if (allowedTables.Any())
//             {
//                 rows = rows.Where(x => allowedTables.Contains(x.Key, StringComparer.OrdinalIgnoreCase)).ToList();
//             }

//             if (excludedTables.Any())
//             {
//                 rows = rows.Where(x => !excludedTables.Contains(x.Key, StringComparer.OrdinalIgnoreCase)).ToList();
//             }
